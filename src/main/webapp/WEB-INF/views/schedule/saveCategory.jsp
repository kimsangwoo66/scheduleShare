                ...
                <h2>일정 카테고리를 선택해주세요</h2>
                    <div class="card-detail">
                        <div class="col-sm">
                            ...
                            <button type="submit" id="catName" name="catName" value="${category[0].name}" onclick="cateBtn(value)">
                                <input type="submit" name="catId" value ="${category[0].category_id}" hidden>
